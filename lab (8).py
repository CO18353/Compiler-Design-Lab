...
def parse(user_input, start_symbol, parsingTable):
    ...
    index = 0
    print('{:>30}'.format("TOP of Stack"), end="")
    print('{:>30}'.format("Input Buffer"), end="")
    print('{:>30}'.format("Move"), end="")
    while len(stack) > 0:
        print()
        top = stack[len(stack) - 1]

        #print("Top =>", top)
        print('{:>30}'.format(str(stack)), end="")
        current_input = user_input[index]

        # print("Current_Input => ", current_input)
        print('{:>30}'.format(user_input[index:]), end="")
        ...
        if top == current_input:
            ...
            #print(key)
            print('{:>30}'.format(str(key[0])+"->"+str(parsingTable[key])), end="")
...
if __name__ == "__main__":
    ...
    st = input("Enter the string to parse: ")
